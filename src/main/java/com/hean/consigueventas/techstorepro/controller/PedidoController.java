...
public class PedidoController {
    ...
    public ResponseEntity<PedidoDTO> realizarPedido() {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(pedidoService.registrarPedidoDesdeCarrito());
    }
    ...
    public ResponseEntity<PedidoDTO> cancelarPedido(
        ...
        return ResponseEntity.ok(pedidoService.cancelarPedidoPropio(id, motivo));
    }
    ...
    public ResponseEntity<MensajeResponse> ocultarPedido(@PathVariable Long id) {
        pedidoService.ocultarPedidoParaUsuario(id);
